...
<body>
    ...
    <div class="top-menu">
        ...
        <div class="sign-in-sign-up-btn user-pic">

      

             <div class="user-profile-pic " id="user-info">
                <img src="https://cdn-icons-png.flaticon.com/512/1946/1946429.png" class="user" alt="user">
